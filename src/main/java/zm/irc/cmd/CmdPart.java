...
public class CmdPart implements IrcChatMsgCmd{
    ...
    public boolean execute(IrcReceiveCmdMessage cmd, IrcClient client) {
        ...
        this.doPartChannel(cmd,params,client);
        return true;
    }
     ...
     * @param channelNames
     */
    private void doPartChannel(IrcReceiveCmdMessage cmd,Object[] channelNames, IrcClient client){
        ...
        for(Object channelName : channelNames) {
            ...
            client.part((String) channelName);
        }
    }
}
